        ...
        <form method="post" action="{{action('QuoteTermController@update', $pk_term_id)}}">
            ...
            <div class="form-row">
                <div class="form-group col-sm">
                    ...
                    <input type="text" class="form-control" id="termName" name="term_name" value="{{$quoteterms->term_name}}">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm">
                    <label for="input">Quote terms description</label>
                    <textarea class="form-control" id="termBody" name="term_body" placeholder="{{$quoteterms->term_body}}" value="{{$quoteterms->term_body}}" rows="10">{{$quoteterms->term_body}}</textarea>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-sm">
